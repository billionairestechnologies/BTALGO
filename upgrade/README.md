...
- Adds user linking between Telegram and BTAlgo
...
1. **Module not found errors**: Ensure you're running from the BTAlgo directory with virtual environment:
   ```bash
   cd /path/to/btalgo
...
*For full documentation, see [BTAlgo Documentation](../docs/)*