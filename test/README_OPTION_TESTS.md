...
1. Enable **Analyze Mode** in BTAlgo settings
2. Run the tests
...
1. Disable **Analyze Mode** in BTAlgo settings
2. Run the tests
...
**Solution**: Make sure BTAlgo is running at `http://127.0.0.1:5000`
...
{
  "status": "error",
  "message": "Invalid btalgo apikey"
}
```

**Solution**: Replace API key in test file with your actual API key from BTAlgo settings
...
- Check BTAlgo logs for detailed error messages
