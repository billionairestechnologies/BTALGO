...
Three tables, all in db/btalgo.db. Hashing pipeline is identical to the
...
# alongside users in db/btalgo.db. No new secret material is introduced.
...
def init_db() -> None:
    ...
    logger.info("Initializing OAuth tables in db/btalgo.db ...")
