# BTAlgo Frontend Documentation

Welcome to the BTAlgo React frontend documentation. This guide covers everything you need to know to develop, test, and maintain the frontend application.
...
BTAlgo frontend is a single-page application (SPA) that provides:
