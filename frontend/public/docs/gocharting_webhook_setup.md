...
GoCharting is a professional HTML5 charting platform optimized for Indian markets. With a **Premium Plan**, you can set up webhook alerts to automate your trading strategies with BTAlgo.
...
### 2. BTAlgo Setup
- BTAlgo instance running and accessible
- API key configured in BTAlgo
...
If you're running BTAlgo locally (on your computer) and want to test webhooks, you'll need to expose your local server to the internet using a tunneling service.
...
1. **Login to BTAlgo**
   - Navigate to your BTAlgo dashboard
...
5. **Configure Delivery Methods**
   ...
   - ☑️ **Webhook**: Enable this for BTAlgo integration

   **Webhook URL**: Paste your BTAlgo webhook URL
   ```
   https://yourdomain.com/api/v1/placeorder
   ```
...
1. **Enable Sandbox Mode in BTAlgo**
...
1. Enable **Analyze Mode** in BTAlgo (toggle in navbar)
2. Create a test alert in GoCharting with a condition that will trigger immediately
3. Check the **API Analyzer** in BTAlgo to see the incoming request
...
```json
{
  "apikey": "your_api_key_here",      // Your BTAlgo API key
...
|-------|----------|-------------|--------------|
| apikey | Yes | Your BTAlgo API key | String |
...
4. **Test tunnel accessibility**
   ...
   - You should see BTAlgo login page
...
### 3. Monitor Activity
- Regularly check order logs in BTAlgo
...
BTAlgo has rate limiting to prevent abuse:
...
### Documentation
- BTAlgo Docs: https://docs.billionairestechnologies.com
- GoCharting Help: https://gocharting.com/help

### Community
- BTAlgo GitHub: https://github.com/billionairestechnologies/btalgo
- Report Issues: https://github.com/billionairestechnologies/btalgo/issues

### Video Tutorials
- Check BTAlgo YouTube channel for video guides
...
A: Check the Logs section in BTAlgo or use the API Analyzer in Analyze Mode.
...
**Happy Trading with GoCharting and BTAlgo! 🚀**
