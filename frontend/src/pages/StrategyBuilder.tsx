...
// Convert DD-MMM-YYYY (API-returned expiry) to DDMMMYY (BillionairsHQ symbol format).
...
export default function StrategyBuilder() {
  ...
  // BillionairsHQ-symbol → tick size map, built from the live option chain.
  ...
  // Expiries are normalised to the BillionairsHQ DDMMMYY format at the source so that
  ...
  const saveEditedLeg = useCallback(
    (updated: StrategyLeg) => {
      // Normalise expiry to the BillionairsHQ DDMMMYY format — the dropdown may
