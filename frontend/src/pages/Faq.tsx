...
const faqData = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: 'Does BTAlgo support paper trading?',
        answer:
          'Yes! BTAlgo includes an Analyzer/Sandbox mode with virtual capital of Rs. 1 Crore. This allows you to test strategies in a realistic environment with proper margin calculations, auto square-off at exchange timings, and complete isolation from live trading. Perfect for testing before going live.',
      },
      {
...
export default function Faq() {
  ...
  const navLinks = [
    ...
    { href: 'https://www.billionairestechnologies.com/discord', label: 'Community', internal: false },
    { href: 'https://www.billionairestechnologies.com', label: 'Roadmap', internal: false },
    { href: 'https://www.billionairestechnologies.com', label: 'Docs', internal: false },
  ]
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="left" className="w-80">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <a
                    href="https://www.billionairestechnologies.com/discord"
                    target="_blank"
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Find answers to common questions about BTAlgo, its features, security, and licensing.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="text-center">
                ...
                <CardContent>
                  ...
                  <Button variant="outline" asChild>
                    <a href="https://www.billionairestechnologies.com" target="_blank" rel="noopener noreferrer">
                      Read Docs
                    </a>
                  </Button>
                </CardContent>
              ...
              <Card className="text-center">
                ...
                <CardContent>
                  ...
                  <Button variant="outline" asChild>
                    <a href="https://www.billionairestechnologies.com/discord" target="_blank" rel="noopener noreferrer">
                      Join Discord
                    </a>
                  </Button>
                </CardContent>
