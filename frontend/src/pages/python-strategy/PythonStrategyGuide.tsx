    ...
    <div className="container mx-auto py-6 space-y-6 max-w-4xl">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Self-host automated trading strategies inside BTAlgo. Each strategy runs as an
        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="resource-limits">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>
                  ...
                  crashing BTAlgo. On Windows, these are not enforced at the OS level.
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <thead>
            ...
            <AccordionItem value="restart">
              <AccordionTrigger>
                What happens if I restart BTAlgo?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground space-y-3">
