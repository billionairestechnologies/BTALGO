# btalgo/broker/nubra/api/nubrawebsocket.py
"""
...
using synchronous websocket-client (standard BTAlgo dependency) instead of aiohttp.
...
class NubraWebSocket:
    ...
    def __init__(self, auth_token: str, device_id: str = "BTALGO", token_provider=None):
        self.bt = auth_token
