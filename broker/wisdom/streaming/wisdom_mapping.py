...
class WisdomExchangeMapper:
    """Maps between BTAlgo exchange codes and Wisdom XTS specific exchange types"""

    # Exchange type mapping for Wisdom XTS broker
    # Format: {BTAlgo_Exchange: Wisdom_Exchange_Code}
    ...
    # Reverse mapping for converting Wisdom exchange codes to BTAlgo format
    # Format: {Wisdom_Exchange_Code: BTAlgo_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert BTAlgo exchange code to Wisdom XTS specific exchange type
    ...
    @staticmethod
    def get_btalgo_exchange(wisdom_code):
        """
        Convert Wisdom XTS exchange code to BTAlgo exchange code
