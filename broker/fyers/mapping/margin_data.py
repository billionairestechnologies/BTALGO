...
def transform_margin_positions(positions):
    """
    Transform BTAlgo margin position format to Fyers margin format.
...
def parse_margin_response(response_data):
    """
    Parse Fyers margin response to BTAlgo standard format.
    ...
    try:
        ...
        # Return standardized format matching BTAlgo specification
