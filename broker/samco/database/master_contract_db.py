...
def process_samco_data(df):
    """
    Process Samco ScripMaster CSV data to fit the BTAlgo database schema.
    """
    ...
    # Convert expiry date to BTAlgo format (DD-MMM-YY)
    ...
    # Map index instruments to BTAlgo exchange format
