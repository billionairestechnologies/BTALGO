...
class IbullsExchangeMapper:
    """Maps between BTAlgo exchange codes and Ibulls XTS specific exchange types"""

    # Exchange type mapping for Ibulls XTS broker
    # Format: {BTAlgo_Exchange: iBulls_Exchange_Code}
    ...
    # Reverse mapping for converting iBulls exchange codes to BTAlgo format
    # Format: {iBulls_Exchange_Code: BTAlgo_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert BTAlgo exchange code to Ibulls XTS specific exchange type
    ...
    @staticmethod
    def get_btalgo_exchange(ibulls_code):
        """
        Convert Ibulls XTS exchange code to BTAlgo exchange code
