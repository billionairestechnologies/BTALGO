...
class IiflExchangeMapper:
    """Maps between BTAlgo exchange codes and Iifl XTS specific exchange types"""

    # Exchange type mapping for Iifl XTS broker
    # Format: {BTAlgo_Exchange: Iifl_Exchange_Code}
    ...
    # Reverse mapping for converting Iifl exchange codes to BTAlgo format
    # Format: {Iifl_Exchange_Code: BTAlgo_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert BTAlgo exchange code to Iifl XTS specific exchange type
    ...
    @staticmethod
    def get_btalgo_exchange(iifl_code):
        """
        Convert Iifl XTS exchange code to BTAlgo exchange code
