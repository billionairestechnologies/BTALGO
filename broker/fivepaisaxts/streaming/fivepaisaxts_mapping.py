...
class FivepaisaXTSExchangeMapper:
    """Maps between BTAlgo exchange codes and Fivepaisa XTS specific exchange types"""

    # Exchange type mapping for Fivepaisa XTS broker
    # Format: {BTAlgo_Exchange: Fivepaisa_Exchange_Code}
    ...
    # Reverse mapping for converting Fivepaisa exchange codes to BTAlgo format
    # Format: {Fivepaisa_Exchange_Code: BTAlgo_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert BTAlgo exchange code to Fivepaisa XTS specific exchange type
    ...
    @staticmethod
    def get_btalgo_exchange(fivepaisaxts_code):
        """
        Convert Fivepaisa XTS exchange code to BTAlgo exchange code
