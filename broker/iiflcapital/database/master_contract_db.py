...
def format_strike(strike_val):
    """Format strike price for BTAlgo symbol. Integer if whole number, else decimal."""
    try:
...
def process_iiflcapital_indices_csv(path):
    ...
    # Determine BTAlgo exchange from CSV Exchange column
