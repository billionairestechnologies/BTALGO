...
# ─── Product / Order type mappings (BTAlgo ↔ AliceBlue V2) ──────────────────
...
def reverse_map_product_type(product):
    """Map AliceBlue V2 product type back to BTAlgo product type."""
    mapping = {
        "LONGTERM": "CNC",
        "NRML": "NRML",
        "INTRADAY": "MIS",
...
def map_order_type(pricetype):
    """Map BTAlgo price type to AliceBlue V2 order type."""
    mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
        "SL": "SL",
...
def reverse_map_order_type(order_type):
    """Map AliceBlue V2 order type back to BTAlgo price type."""
    mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
        "SL": "SL",
...
# ─── Payload builders (BTAlgo request → AliceBlue V2 API payload) ──────────


def transform_data(data):
    """
    Transform an BTAlgo place-order request into an AliceBlue V2 API payload item.
    """
...
def transform_modify_order_data(data):
    """
    Transform an BTAlgo modify-order request into an AliceBlue V2 API modify payload.
    """
    return {
