...
def transform_data(data, token):
    """
    Transforms BTAlgo order format to Tradejini API format.
    """
...
def transform_modify_order_data(data, token):
    """
    Transforms BTAlgo modify order format to Tradejini API format.

    Args:
        data (dict): BTAlgo modify order data
...
def map_order_type(pricetype):
    """
    Maps BTAlgo order types to Tradejini order types.
    """
    order_type_mapping = {
        "MARKET": "market",
        "LIMIT": "limit",
...
def map_product_type(product):
    """
    Maps BTAlgo product types to Tradejini product types.
    """
...
def map_validity(validity):
    """
    Maps BTAlgo validity types to Tradejini validity types.
    """
...
def reverse_map_product_type(product):
    """
    Maps Tradejini product types back to BTAlgo product types.
    """
