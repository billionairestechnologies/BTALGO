...
def transform_margin_positions(positions):
    """
    Transform BTAlgo margin position format to RMoney XTS margin API format.
...
def parse_margin_response(response_data):
    """
    Parse RMoney XTS margin calculator response to BTAlgo standard format.
    ...
    Returns:
        dict: Parsed margin data in BTAlgo format
    """
