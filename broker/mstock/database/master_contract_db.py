...
def convert_date(date_str):
    """
    Convert date format to BTAlgo expiry column format: DD-MMM-YY (with hyphens).
    Example: '19MAR2024' -> '19-MAR-24' or '2024-03-19' -> '19-MAR-24'

    BTAlgo Expiry Column Format: DD-MMM-YY (e.g., 28-MAR-24, 25-APR-24)
...
def fetch_and_process_mstock_indices():
    ...
    try:
        ...
        # Standardize NSE index symbols that differ from BTAlgo standard format
...
def process_mstock_json(json_data):
    """
    Processes the MStock JSON data to fit the BTAlgo database schema.
    ...
    # MStock API returns NSE/BSE for currency, but BTAlgo uses CDS/BCD
    # -------------------------------------------------------------------
    ...
    # Convert expiry dates to BTAlgo format (DD-MMM-YY)
    ...
    try:
        ...
        if bse_index_tokens:
            ...
            # Normalize BSE Index symbols to BTAlgo standard format
    ...
    # -------------------------------------------------------------------
    # Format F&O Symbols (BTAlgo Standard)
    ...
    # -------------------------------------------------------------------
    # Normalize instrumenttype to BTAlgo standard (match Angel format)
