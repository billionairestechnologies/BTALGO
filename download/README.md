...
This tool allows you to download Intraday End of Day (IEOD) data for specified stock symbols from the BTAlgo API.

## Prerequisites

- Python 3.x
- Valid BTAlgo API key
- Access to BTAlgo API endpoint (ensure btalgo is running)
...
1. Ensure you have a valid API key from BTAlgo
