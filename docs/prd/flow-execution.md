...
├── flow_btalgo_client.py     # BTAlgo API wrapper (~500 lines)
...
| `FlowBTAlgoClient` | Wraps BTAlgo internal APIs |
...
def execute_workflow(
    ...
    # 3. Create executor with BTAlgo client
    client = FlowBTAlgoClient(api_key)
