...
<html>
<head>
    <title>System Health Monitor - BTAlgo</title>
    <!-- Add your styles -->
</head>
<body>
    <div class="container">
...
tail -f logs/btalgo.log | grep -i health
...
fd_gauge = Gauge('btalgo_fd_count', 'File descriptor count')
memory_gauge = Gauge('btalgo_memory_mb', 'Memory usage in MB')
