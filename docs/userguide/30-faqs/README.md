...
BTAlgo is an open-source algorithmic trading platform that connects various trading platforms (TradingView, Amibroker, Python) to Indian stock brokers through a unified API.

### Is BTAlgo free?

Yes, BTAlgo is completely free and open-source. You can download, use, and modify it without any cost.

### Which brokers are supported?

BTAlgo supports 29 Indian brokers including:
- Zerodha
- Angel One
- Dhan
- Upstox
...
### Can I use BTAlgo for live trading?

Yes, BTAlgo supports live trading with real money. However, we strongly recommend:
...
### Can I run BTAlgo on a VPS/Cloud?

Yes, BTAlgo can run on:
- AWS EC2/Lightsail
- Google Cloud
- DigitalOcean
- Azure
...
Most Indian brokers require daily authentication for security. This is a broker requirement, not an BTAlgo limitation.

### Can I use multiple brokers?

Currently, BTAlgo supports one broker at a time. You can switch between brokers by changing the configuration.
...
Yes, BTAlgo fully supports F&O trading. Use correct symbol format:
- Futures: `NIFTY30JAN25FUT`
- Options: `NIFTY30JAN2521500CE`

### What is Analyzer Mode?

Analyzer Mode is BTAlgo's sandbox testing environment. It simulates trading with ₹1 Crore sandbox capital using real market prices but no real money.

### Can I backtest strategies?

BTAlgo is primarily for live trading and walkforward testing strategies. For backtesting:
- Use TradingView's strategy tester
- Use Amibroker's backtesting
- Use Python backtesting libraries

### What happens if BTAlgo crashes during a trade?
...
### How do I connect TradingView to BTAlgo?

1. Enable BTAlgo accessible via internet (ngrok/cloud)
2. Create webhook alert in TradingView
3. Use BTAlgo endpoint URL
...
Report security vulnerabilities to: security@billionairestechnologies.com (or via GitHub private advisory)
...
BTAlgo is community-driven. Get help through:

1. Documentation: [https://docs.billionairestechnologies.com](https://docs.billionairestechnologies.com)
2. Discord Community: [http://billionairestechnologies.com/discord](http://billionairestechnologies.com/discord)
3. GitHub Issues: [https://github.com/billionairestechnologies/btalgo/issues](https://github.com/billionairestechnologies/btalgo/issues)
...
### Is BTAlgo really free?

Yes, BTAlgo is 100% free and open-source under the AGPL license.

### Are there any hidden costs?

No hidden costs from BTAlgo. You may have:
...
### "BTAlgo is a trading bot"

BTAlgo is a **bridge/platform**, not a trading bot. It connects your strategy signals to your broker. You still need to create or use existing strategies.

### "I can make guaranteed profits"

No trading system guarantees profits. BTAlgo is a tool - your results depend on your strategy.

### "It works without internet"

BTAlgo requires internet connection to communicate with brokers and receive signals.

### "I can trade after market hours"

BTAlgo follows exchange timings. F&O can be traded during extended hours as per exchange rules.
...
2. Check [GitHub Discussions](https://github.com/billionairestechnologies/btalgo/discussions)
