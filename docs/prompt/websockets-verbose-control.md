...
```python
"""
Test verbose control in BTAlgo WebSocket Feed
"""
from openalgo import api
import time
...
```
GET https://docs.billionairestechnologies.com/trading-platform/python/websockets-verbose-control.md?ask=<question>
```
