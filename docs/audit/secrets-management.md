...
This assessment covers how BTAlgo protects your sensitive data: broker credentials, API keys, and encryption secrets.

**Risk Level**: Critical (data sensitivity)
**Status**: Good

## What Secrets Does BTAlgo Store?
...
|------|----------|-------------|
| `btalgo.db` | Users, orders, settings | High |
...
- [ ] Strong password for BTAlgo login
...
**Actions**:
1. Logout from BTAlgo
2. Revoke broker tokens (in broker dashboard)
3. Generate new API key in BTAlgo
